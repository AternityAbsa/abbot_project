...
export class LoginComponent implements OnInit {
    ...
    Login(): void{
      console.log("What up?" + this.username, this.rememberMe, this.password);
      this.authenticationService.login("adminLocalhost", this.rememberMe, this.password).subscribe(
        data => {
