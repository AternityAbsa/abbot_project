...
import { BASE_PATH, ABBOT_PROCESS_STEP_CONTROLLER_API } from '../services/services';
...
export class ProcessStepControllerService {
    ...
    public getAllProcessSteps(){
        return this.http.get(BASE_URL + ABBOT_PROCESS_STEP_MANAGEMENT_API, { headers: this.headers})
