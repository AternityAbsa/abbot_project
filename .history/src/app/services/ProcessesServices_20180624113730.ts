...
export class ProcessesService {
    ...
    private service = '/HOST_RESOURCES_HOURLY?$filter=(SERVING_DEVICE_TYPE%20eq%20%27Virtual%20App%20Server%27)&$top=7';
    ...
    /* https://eu-odata.aternity.com/aternity.odata/APPLICATIONS_RAW?$select=APPLICATION,APPLICATION_TYPE,CRASHES,HANG_TIME,WAIT_TIME,ERRORS,TIMEFRAME **/
