...
export class ProcessesService {
     ...
     */
     ...
     public getProcesses(): Observable<any[]>{
        return this.http.get(this.process_basepath + this.process_rest_api, this.options)
     ...
     public getProcess(id:Number){
        return this.http.get(this.process_basepath + this.process_rest_api + id, this.options)
        .map((response: Response) => {
            if (response.status === 204) {
                return undefined;
            } else if (response.status === 500) {
     ...
     createProcess(process: ProcessModel){
        return this.http.post(this.process_basepath + this.process_rest_api, JSON.stringify(process), this.options)
        .map((response: Response) => {
            if (response.status === 204) {
                return undefined;
            } else if (response.status === 500) {
     ...
     updateProcess(process: ProcessModel){
        return this.http.put(this.process_basepath + this.process_rest_api, JSON.stringify(process), this.options)
        .map((response: Response) => {
            if (response.status === 204) {
                return undefined;
            } else if (response.status === 500) {
     ...
     deleteProcess(id:Number){
        return this.http.delete(this.process_basepath + this.process_rest_api + id, this.options)
        .map((response: Response) => {
            if (response.status === 204) {
                return undefined;
            } else if (response.status === 500) {
