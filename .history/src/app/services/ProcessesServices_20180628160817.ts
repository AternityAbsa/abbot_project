...
export class ProcessesService {
     ...
     */
     ...
     public getAbBotProcesses(): Observable<any[]>{
     ...
     createNewProcess(process: ProcessModel){
        return this.http.post(this.process_basepath +'/processes', JSON.stringify(processes,)
     }

     deleteProcess(id:Number){
        return this.http.post(this.process_basepath + '/processes' + id, this.options)
