http://localhost:8080/import { Injectable } from '@angular/core';
...
export class ProcessesService {
    http://localhost:8080/abbot/user-management

    private process_rest_api = 'abbot/abbot-action-management';
