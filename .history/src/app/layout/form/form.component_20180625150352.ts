...
export class FormComponent implements OnInit {
    ...
    constructor(private processService : ProcessesService, private processModel : ProcessModel) {
        this.process_List.push(new ProcessList('1', 'cif search', 'A', '14h00', 'abmg101'));
        this.process_List.push(new ProcessList('2', 'open fbss', 'B', '16h00', 'abtest201'));
        this.process_List.push(new ProcessList('3', 'avaf application', 'NA', '11h00', 'abga301));
        }
