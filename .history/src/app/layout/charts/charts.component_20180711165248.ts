...
export class ChartsComponent implements OnInit {
    ...
    model : ProcessModel = { abbotProcessSteps:[],createdBy:[1 , 'ROLE_ADMIN' , 1], description: 'Test5', lastModifiedBy: [1 , 'ROLE_ADMIN' , 1],
                            deleted:false, name: 'muzi', processType: 'Test5', runmode: 'C', sharedObject:5};
