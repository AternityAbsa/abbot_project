...
class ProcessList {
    ...
    constructor(  public processId: string = '', public name: string = '', public description: string = '', 
                  ...
                  public sharedObject: number = 0, public createdDate : Date, public processType: string=''
          ) 
    {
        this.Value = Value;
...
export class ChartsComponent implements OnInit {
    ...
    constructor(private processService : ProcessesService, private processModel : ProcessModel, private createUserModifiedBy: CreatedByOrLastModifiedBy,
                ...
                private fb: FormBuilder, private formControl: FormControl) {
                this.createForm();
    }
    ...
    this.processModel.processType = this.processControl. processType; 
    this.processModel.runmode = processForm.runmode;
    this.processModel.sharedObject = processForm.sharedObject;
    this.processModel.version = processForm.version;
