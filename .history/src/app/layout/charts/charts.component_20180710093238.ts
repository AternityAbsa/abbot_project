...
export class ChartsComponent implements OnInit {
    ...
    constructor(public dialog : MatDialog, private processService : ProcessesService, private processModel : ProcessModel, private router : Router) {
        }
...
//   }
  ...
  deleteProcess(process){
    ...
    createNewProcess(error: string){
        this.dialog.open(AddProcessFormComponent, {
