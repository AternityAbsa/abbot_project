    ...
    constructor(private processService : ProcessesService, private processModel : ProcessModel) {
        ...
        loadProcesses(): Observable<any>[]{
            this.processService.getAbBotProcesses().subscribe(
                ...
                this.processModel.processName = processes['value'].map(blue_applications => blue_applications.UXI);
                this.processModel.processStatus = processes['value'].map(blue_applications => blue_applications.UXI);
