...
export class ChartsComponent implements OnInit {
    ...
    saveProcess(processType,name, description, runmode, sharedObject,version,createdByUserId,lastModifiedByUserId){
    ...
    this.processModel.name = "Test6";
    this.processModel.processType = "Test6"; 
    this.processModel.runmode = "Yebo Baba";
    this.processModel.sharedObject = 6;
    this.processModel.version = "Yebo Baba";
