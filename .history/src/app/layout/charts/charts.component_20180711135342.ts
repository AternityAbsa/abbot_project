...
export class ChartsComponent implements OnInit {
    ...
    constructor(private processService : ProcessesService, private processModel : ProcessModel,
               private router : Router, private modalService: NgbModal, private modalReference: NgbModalRef, private fb: FormBuilder) {
                 this.createForm();
        }
  ...
  onAddNewProcess(content,processType, name, runmode, sharedObject, description, version,createdDate, lastModifiedDate, createdByUserId, lastModifiedByUserId){
   
    let dateString = '2018-07-11 08:20:06' 
    createdDate = new Date(dateString);
    let dateString2 = '2018-07-10 08:20:06' 
    lastModifiedDate = new Date(dateString2);

    this.processModel.processId = 3;
    this.processModel.processType = 'Test3';
    this.processModel.name = 'Test3';
    this.processModel.description = 'Test3';
    this.processModel.runmode = 'C';
    this.processModel.sharedObject = 3;
    this.processModel.version = 3;
    this.processModel.createdDate = createdDate;
    this.processModel.createdUserId = 1;
    this.processModel.lastModifiedByUserId = 1;
    this.processModel.lastModifiedDate = lastModifiedDate;
