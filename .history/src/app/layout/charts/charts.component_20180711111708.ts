...
export class ChartsComponent implements OnInit {
  ...
  onAddNewProcess(processType, name, runmode, sharedObject, description, version,createdDate, lastModifiedDate, createdByUserId, lastModifiedByUserId){
   this.processModel.processId = 3;
    ...
    this.processModel.createdDate = "2018-07-08 08:20:06";
    this.processModel.createdUserId = createdByUserId;
    this.processModel.lastModifiedByUserId = lastModifiedByUserId;
