...
export class ChartsComponent implements OnInit {
  ...
  updateProcess(processType.value, name.value, runmode.value, sharedObject.value, version.value){
    console.log(process.processType, process.name, process.runmode, process.sharedObject, process.version);
    // this.processModel.abbotProcessSteps = [];
    // this.userRole.id = 1;
    // this.createUserModifiedBy.abbotUserRole = this.userRole;
    // this.createUserModifiedBy.authorities = ["ROLE_ADMIN"];
    ...
    // this.processModel.createdBy = this.createUserModifiedBy;
    // this.processModel.lastModifiedBy = this.createUserModifiedBy;
    // this.processModel.name = process.name;
    // this.processModel.processType = process.processType; 
    // this.processModel.runmode = process.runmode;
    // this.processModel.sharedObject = process.sharedObject;
    // this.processModel.version = process.version;
